...
These configs freeze the names used in the Next7 baseline-gap tables:
...
| `configs/paper/hgb_hesf_lvc_t.yaml` | HeSF-LVC-T | Pareto knee T, `lambda_spec=2.0`, `lambda_conv=0.25`, `lambda_rel=0` |
